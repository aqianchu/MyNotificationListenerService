...
import com.scu.ntest.MainActivity;
...
class Authenticator extends AbstractAccountAuthenticator {
    ...
    public Bundle addAccount(AccountAuthenticatorResponse response, String accountType,
        ...
        // 已登录进首页 未登录进登录页
//        Class<?> activity = UserLoginManager.isAccountLegal(mContext) ? MainActivity.class : UplineLoginActivity.class;
        Class<?> activity = MainActivity.class;
        final Intent intent = new Intent(mContext, activity);
